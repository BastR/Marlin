...
#define HOMING_BACKOFF_POST_MM { 40, 40, 0 }  // (mm) Backoff from endstops after homing
...
#define Z_STEPPER_AUTO_ALIGN
  ...
  //#define Z_STEPPER_ALIGN_KNOWN_STEPPER_POSITIONS
    ...
    #define Z_STEPPER_ALIGN_STEPPER_XY { { -35, 78 }, { 530, 78 }, { 250, 560 } }
  #else
...
// @section lcd
  ...
  #define MANUAL_FEEDRATE { 100*60, 100*60, 4*60, 4*60 } // (mm/min) Feedrates for manual moves along X, Y, Z, E from panel
...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define PAUSE_PARK_RETRACT_LENGTH          0.8  // (mm) Initial retract.
                                                  // This short retract is done immediately, before parking the nozzle.
  #define FILAMENT_CHANGE_UNLOAD_FEEDRATE     60  // (mm/s) Unload filament feedrate. This can be pretty fast.
  #define FILAMENT_CHANGE_UNLOAD_ACCEL       600  // (mm/s^2) Lower acceleration may allow a faster feedrate.
  ...
  #define ADVANCED_PAUSE_PURGE_LENGTH         88  // (mm) Length to extrude after loading.
  ...
  #define FILAMENT_UNLOAD_PURGE_RETRACT      0.8  // (mm) Unload initial retract length.
